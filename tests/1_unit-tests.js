...
suite('Unit Tests', function () {
  suite('Basic Assertions', function () {
    ...
    // #3
    // NotOk: falsy: false/ 0/ -0/ ''/ null/ undefined/ NaN
  ...
  suite('Equality', function () {
    ...
    test('#strictEqual, #notStrictEqual', function () {
      ...
      assert.strictEqual(6 * '2', 12); // math comes first, 6 * 2
      assert.notStrictEqual([1, 'a', {}], [1, 'a', {}]);
    });
    
    // #7
    // deepEqual: numbers of key should same, key value should same, index should same
  ...
  suite('Arrays', function () {
    ...
    // #12
   // 2nd element is what i am looking for
